...
namespace Blazor.ECharts.Options
{
    public class TextStyle
    {
        ...
        /// <summary>
        /// 文字块背景色。
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#radar.name.backgroundColor">此处</see>查看详细设置</para>
        /// </summary>
        ...
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#title.textStyle.width ">此处</see>查看详细设置</para>
        /// </summary>
        public object Width { set; get; }

        /// <summary>
        /// 文字块的高度。一般不用指定，不指定则自动是文字的高度。在使用图片（参见 backgroundColor）时，可能会使用它。
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#title.textStyle.height ">此处</see>查看详细设置</para>
        /// </summary>
        ...
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#title.textStyle.rich ">此处</see>查看详细设置</para>
        /// </summary>
