...
namespace Blazor.ECharts.Options.Series
{
    public record Label
    {
        ...
        /// <para>可以支持使用图片</para>
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#series-pie.data.label.backgroundColor">此处</see>查看详细设置</para>
        /// </summary>
        ...
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#series-pie.data.label.rich">此处</see>查看详细设置</para>
        /// </summary>
        ...
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#series-pie.data.label.width">此处</see>查看详细设置</para>
        /// </summary>
        ...
        /// <para>注意，如果不定义 rich 属性，则不能指定 width 和 height。</para>
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#series-pie.data.label.height">此处</see>查看详细设置</para>
        /// </summary>
        public object Height { set; get; }

        /// <summary>
        /// 文字块的内边距。
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#series-pie.data.label.padding">此处</see>查看详细设置</para>
        /// </summary>
