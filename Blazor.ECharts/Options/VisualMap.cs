...
namespace Blazor.ECharts.Options
{
    public record VisualMapPiecewise
    {
        ...
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#visualMap-piecewise.pieces">此处</see>查看详细设置</para>
        /// </summary>
        public List<object> Pieces { set; get; }

        /// <summary>
        /// 定义 在选中范围外 的视觉元素。（用户可以和 visualMap 组件交互，用鼠标或触摸选择范围）
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#visualMap-piecewise.outOfRange">此处</see>查看详细设置</para>
        /// </summary>
        ...
        /// <para>点击<see href="https://echarts.apache.org/zh/option.html#visualMap-continuous.inRange">此处</see>查看详细设置</para>
        /// </summary>
